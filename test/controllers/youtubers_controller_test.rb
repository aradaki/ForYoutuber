...
class YoutubersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create youtuber" do
    assert_difference('Youtuber.count') do
      post youtubers_url, params: { youtuber: { image_id: @youtuber.image_id, introduction: @youtuber.introduction, name: @youtuber.name } }
    end
  ...
  test "should update youtuber" do
    patch youtuber_url(@youtuber), params: { youtuber: { image_id: @youtuber.image_id, introduction: @youtuber.introduction, name: @youtuber.name } }
